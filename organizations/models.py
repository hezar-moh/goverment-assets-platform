...
class OrgUnit(models.Model):
    ...
    unit_type = models.CharField(
        max_length=20, choices=UNIT_TYPE_CHOICES, help_text="Level in the hierarchy"
    )
    ...
    manager_id = models.IntegerField(
        null=True, blank=True, help_text="ID of the CustomUser who manages this unit"
    )
...
class MasterData(models.Model):
    ...
    value = models.CharField(
        max_length=100, help_text="The stored code value. Example: GOVT"
    )
    ...
    sort_order = models.IntegerField(
        default=0, help_text="Controls display order in dropdowns"
    )
    created_at = models.DateTimeField(auto_now_add=True)
...
class AuditLog(models.Model):
    ...
    performed_by_id = models.IntegerField(
        null=True, help_text="ID of the CustomUser who performed this action"
    )
    ...
    performed_by_role = models.CharField(
        max_length=50,
        blank=True,
        help_text="Role of the user at time of action — snapshot",
    )
